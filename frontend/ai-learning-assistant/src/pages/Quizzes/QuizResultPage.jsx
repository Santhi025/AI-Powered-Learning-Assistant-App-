...
const QuizResultPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score Card*/}
      <div className="bg-white backdrop-blur-xl border-2 border-slate-200 rounded-3xl shadow-xl shadow-slate-200/50 p-8 mb-8">
      ...
      <div className="mt-8 flex justify-center">
        ...
        <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden focus:outline-none focus:ring-4 focus:ring-emerald-500/20 hover:shadow-lg hover:shadow-emerald-500/30 active:scale-95" >

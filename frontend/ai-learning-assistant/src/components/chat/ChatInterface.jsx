...
const ChatInterface = () => {
    ...
    //             timestamp: new Date(),
    //             relavantChunks: response.data.relevantChunks
    //         };
  ...
  return (
    <div className="flex flex-col h-[70vh] bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
        {/* Message Area */}
        <div className="flex-1 p-6 overflow-y-auto bg-linear-to-br from-slate-50/50 via-slate-50/50 to-slate-50">
            ...
            {history.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center px-6">
                    ...
                    <p className="text-sm text-slate-500 max-w-md">
                        Ask me anything about the document and I'll help you understand it better.
                    </p>
                </div>
            ) : (
                history.map(renderMessage)
            ...
            {loading && (
                <div className="flex items-center gap-3 my-4">
                    <div className="w-9 h-9 rounded-xl bg-linear-to-br from-emerald-400 to-teal-500 flex items-center justify-center mb-4 shadow-lg shadow-emerald-500/10">
                        <Sparkles className="w-4 h-4 text-white" strokeWidth={2} />
                    </div>
                    <div className="flex items-center gap-2 px-4 py-3 rounded-2xl rounded-bl-md bg-white border border-slate-200/10">
        ...
        {/* Input Area */}
        <div className="p-5 border-t border-slate-200/10 bg-white/80">

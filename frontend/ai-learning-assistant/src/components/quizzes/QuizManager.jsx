...
const QuizManager = ({ documentId }) => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.dismiss();
      toast.success(
        `'${selectedQuiz.title || 'Quiz'}' deleted successfully.`
      );
        ...
        <form onSubmit={handleGenerateQuiz} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full h-10 px-3 border border-neutral-200 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#00d492]"
            />
          </div>
...
//                     min="1"
//                     required
//                     className="w-full h-9 px-3 border border-neutral-200 rounded-lg bg-white text-sm text-neutral-900 placeholder:text-neutral-400 transition-colors duration-150 focus-outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent "
//                     />
//                 </div>
//                 <div className="flex justify-end gap-2 pt-2">
//                     <Button

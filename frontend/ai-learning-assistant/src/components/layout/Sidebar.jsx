...
const Sidebar = ({isSidebarOpen, toggleSidebar}) => {
    ...
    const navLinks = [
        ...
        {to: '/flashcards', icon: BrainCircuit, text: 'Flashcards'},
  ...
  ></div>
    ...
    <aside className={`fixed top-0 left-0 h-full w-64 bg-white/90 backdrop-blur-lg border-r border-slate-200/50 z-50 md:relative md:w-64 md:shrink-0 md:flex md:flex-col md:translate-x-0 transition-transform duration-300 ease-in-out ${
